...
RSpec.describe Job, type: :model do
  ...
  describe 'scopes' do
    describe '.search_by_term' do
      let!(:job1) { create(:job, title: 'Desenvolvedor Ruby', description: 'Especialista Rails para um grande projeto que iniciará em breve', location: 'São Paulo') }
      let!(:job2) { create(:job, title: 'Desenvolvedor Frontend', description: 'Especialista em Vue.js para criar interfaces modernas', location: 'Remoto') }
      let!(:job3) { create(:job, title: 'Engenheiro DevOps', description: 'Especialista em Docker e Kubernetes para infraestrutura em nuvem', location: 'Viamão') }
